...
function AddNewInterview() {
  ...
  const onSubmit = async (e) => {
    ...
    const InputPromp = "job position:" + jobPosition + ", job description: " + jobDesc + ", years of experience:" + jobExperience + ". According to this information provide me with " + process.env.NEXT_PUBLIC_INTERVIEW_QUESTION_COUNT + " interview questions and their answers in json format"
    const result = await chatSession.sendMessage(InputPromp);
